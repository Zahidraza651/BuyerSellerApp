...
import 'package:seller_side/orders/completed.dart';
import 'package:seller_side/orders/pending.dart';
import 'package:seller_side/orders/rejected.dart';
              ...
              children: [
                Expanded(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(color: const Color(0xffF4BD05), style: BorderStyle.solid),
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: const TextStyle(
                                color: Color(0xffF4BD05), fontSize: 20.0, fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            height: 10.0,
                          ),
                ...
                Expanded(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(color: const Color(0xffFF3B3B), style: BorderStyle.solid),
                          borderRadius: BorderRadius.circular(10.0)),
                      height: MediaQuery.of(context).size.height / 5,
                      //width: MediaQuery.of(context).size.width / 2,
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: const TextStyle(
                                color: Color(0xffFF3B3B), fontSize: 20.0, fontWeight: FontWeight.bold),
                          )
                        ],
                      )),
                  onTap: () {
              ...
              children: [
                Expanded(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(color: const Color(0xff2CC91F), style: BorderStyle.solid),
                          borderRadius: BorderRadius.circular(10.0)),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            completed, //'Completed',
                            style: const TextStyle(
                                color: Color(0xff2CC91F), fontSize: 20.0, fontWeight: FontWeight.bold),
                          ),
                          const SizedBox(
                            width: 20.0,
                          ),
