                    ...
                    : ListView(
                        ...
                        children: [
                          ListTile(
                              ...
                              title:
                                  Text(AppLocalizations.of(context)!.language), //const Text('Language'),
                              trailing: Container(
                          ...
                          ListTile(
                            ...
                            title: Text(AppLocalizations.of(context)!.privacy), //const Text('Privacy'),
                            trailing:
                          ...
                          ListTile(
                            ...
                            title: Text(AppLocalizations.of(context)!.about), //const Text('About'),
                            trailing:
                                IconButton(onPressed: () {}, icon: const Icon(Icons.arrow_forward)),
                          ),
                          ListTile(
                            ...
                            title: Text(AppLocalizations.of(context)!.support), //const Text('Support'),
                            trailing:
                                IconButton(onPressed: () {}, icon: const Icon(Icons.arrow_forward)),
                          ),
                          ListTile(
                            ...
                            title:
                                Text(AppLocalizations.of(context)!.shareApp), //const Text('Share App'),
                            trailing:
                                IconButton(onPressed: () {}, icon: const Icon(Icons.arrow_forward)),
                          ),
                          ListTile(
                            ...
                            title: Text(AppLocalizations.of(context)!.rateUs), //const Text('Rate Us'),
                            trailing:
                                IconButton(onPressed: () {}, icon: const Icon(Icons.arrow_forward)),
                          ),
                          ListTile(
                            ...
                            title: Text(AppLocalizations.of(context)!.logout), //const Text('Logout'),
                            trailing: IconButton(
                                onPressed: () {
                                  showDialog(
                                      context: context,
